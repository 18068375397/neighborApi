 ...
 * @since 2024-03-21<br />
 */
@Schema(description = "운영자 조회 응답")
public record OperatorSearchResponse(
        @Schema(description = "운영자 ID / VARCHAR2(50)", example = "operator01")
        String userId,
        @Schema(description = "운영자 명 / VARCHAR2(256)", example = "운영자1")
        String userName,
        @Schema(description = "권한 ID / VARCHAR2(50)", example = "AUTH00001")
        String authorityId,
        @Schema(description = "권한 명 / VARCHAR(50)", example = "관리자")
        String authorityName,
        @Schema(description = "운영자 전화번호 / VARCHAR2(256)", example = "02-1234-5678")
        String telephone,
        @Schema(description = "운영자 휴대전화 / VARCHAR2(256)", example = "010-5042-2100")
        String cellphone,
